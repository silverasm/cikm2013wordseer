...
\end{center}
    \caption{%
      The Word Menu for `japan'.  Clicking on any of the menu options opens up the slice of matching sentences in a new view \label{fig:intro08}}%
\end{figure}
